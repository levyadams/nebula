...
function add_css() {
	...
	style.id = 'svelte-txjjql-style';
	style.textContent = "body{background:rgb(169, 169, 249);color:white}.img-wrapper.svelte-txjjql{max-width:100%;margin:0 auto 30px}img.svelte-txjjql{max-width:100%}h1.svelte-txjjql{text-align:center;font-size:30px;background:rgba(0, 0, 0, 0.85)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(img, "class", "profile-img svelte-txjjql");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div0, "class", "img-wrapper svelte-txjjql");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(h1, "class", "svelte-txjjql");
...
class Professional_profile_web extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-txjjql-style")) add_css();
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI0OTIwOGQ4YTM2NjNiNjc5Mjk5Zi9zaXRlc19wcm9mZXNzaW9uYWwkNDVwcm9maWxlJDQ1d2ViLnNpdGVzX3Byb2Zlc3Npb25hbCQ0NXByb2ZpbGUkNDV3ZWIuanMiLCJzb3VyY2VzQ29udGVudCI6W10sInNvdXJjZVJvb3QiOiIifQ==